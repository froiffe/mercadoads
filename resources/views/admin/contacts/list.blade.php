...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-list"></i> Listado de contactos</li>
        </ol>
    </section>
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="box-tools pull-right no-print">
                            <a href="{{ route('contacts.export') }}" class="btn btn-primary text-white"><i class="fa fa-download"></i> Exportar</a>
                        </div>
                    </div>
                    <div class="box-body">
                        <table class="table dataTable table-bordered table-striped" id="contacts">
                            <thead>
                                <tr>
                                    <th>Nombre</th>
                                    <th>Apellido</th>
