                    ...
                    <form action="{{ route('administrators.update', $administrator) }}" method="POST">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="name" id="" value="{{ old('name') ? old('name') : $administrator->name  }}">
                            </div>

                            <div class="form-group">
                                <label for="email">Email</label>
                                <input class="form-control" type="text" name="email" id="" value="{{ old('email') ? old('email') : $administrator->email }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="role" id="">
                                    ...
                                    <option {{ old('role') == $role->id ? 'selected' : $administrator->hasRole($role->name) ? 'selected' : '' }} value="{{ $role->id }}">{{ $role->display_name }}</option>
                                    @endforeach
                                </select>
                            </div>
