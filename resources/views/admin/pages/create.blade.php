                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="spanish">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="seo_ogtitle_es" value="{{ old('seo_ogtitle_es') }}">
                                        </div>

                                        <div class="form-group">
                                            <label for="seo_ogdescription_es">Descripción OG SEO</label>
                                            <textarea class="form-control summernote" name="seo_ogdescription_es" cols="30" rows="10">{{ old('seo_ogdescription_es') }}</textarea>
                                        </div>
                                    ...
                                    <div class="tab-pane" id="portugues">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="seo_ogtitle_pt" value="{{ old('seo_ogtitle_pt') }}">
                                        </div>

                                        <div class="form-group">
                                            <label for="seo_ogdescription_pt">Descripción OG SEO</label>
                                            <textarea class="form-control summernote" name="seo_ogdescription_pt" cols="30" rows="10">{{ old('seo_ogdescription_pt') }}</textarea>
                                        </div>
