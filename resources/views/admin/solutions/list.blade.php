...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-list"></i> Listado de formatos</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Listado de formatos</h3>
                        <div class="box-tools pull-right no-print">
                            <a href="{{ route('solutions.create') }}" class="btn btn-primary text-white"><i class="fa fa-plus"></i> Nuevo</a>
                        </div>
                    </div>
                    <div class="box-body">
                        <table class="table dataTable table-bordered table-striped" id="solutions">
                            <thead>
                                <tr>
                                    <th>Categoria</th>
                                    <th>Slug español</th>
