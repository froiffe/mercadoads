...
<main class="main-insights"  data-scroll-section>
    ...
    <section class="section-insights-intro">
        <div class="wrap">
            <div class="area-txt" data-scroll >
                <h2 class="title">{!! trans('paper-01-consolas/general.title') !!}</h2>
            </div>
            <div class="area-img" data-scroll data-scroll data-scroll-delay="0" data-scroll-speed="1" data-scroll-offset="0">
                <picture alt="Mercado Libre Insights" class="desktop">
                    <source srcset="{{ asset(trans('paper-01-consolas/general.image-url-webp')) }}" type="image/webp" media="(min-width: 1024px)">
                    <source srcset="{{ asset(trans('paper-01-consolas/general.image-url')) }}" type="image/jpg" media="(min-width: 1024px)">
                    <img loading="lazy" alt="insights">
                </picture>
                <picture alt="Mercado Libre Insights" class="mobile">
                    <source srcset="{{ asset(trans('paper-01-consolas/general.image-url-mobile-webp')) }}" type="image/webp" media="(max-width: 1023px)">
                    <source srcset="{{ asset(trans('paper-01-consolas/general.image-url-mobile')) }}" type="image/jpg" media="(max-width: 1023px)">
                    <img loading="lazy" alt="insights">
                </picture>
            </div>
        </div>
    ...
    <section class="section-insights-content" data-scroll>
        <div class="wrap w-p125">
            <div class="area-txt">
                <p class="text text-highlight" data-scroll>{!! trans('paper-01-consolas/general.description') !!}</p>

                <p class="text" data-scroll>{!! trans('paper-01-consolas/general.phrase-1') !!}</p>
                <p class="text" data-scroll>{!! trans('paper-01-consolas/general.description-content-1') !!}</p>

                <div class="descarga-content" data-scroll style="display:block">
                    <p class="text" data-scroll>{!! trans('paper-01-consolas/general.descarga-content.phrase') !!}</p>
                    <ul class="campo-list">
                        <li class="campo-item">
                            <div class="campo">
                                <a href="{{ url(trans('paper-01-consolas/general.descarga-content.link-reporte')) }}" target="_blank" class="link"><span class="icon"></span>{!! trans('paper-01-consolas/general.descarga-content.download-reporte') !!}</a>
                            </div>
                            <!-- <div class="campo">
